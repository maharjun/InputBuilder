"""
Module containing implementations of the spike builders
"""
...
from .superimpose_spike_gen import SuperimposeSpikeBuilder
from .repeater_spike_gen import RepeaterSpikeBuilder